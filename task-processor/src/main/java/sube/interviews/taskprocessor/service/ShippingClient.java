...
public class ShippingClient {
	...
	private final String mareoEnviosUrl;

	public ShippingClient(RestTemplate restTemplate, @Value("${app.mareoenvios.url}") String mareoEnviosUrl) {
		this.restTemplate = restTemplate;
		this.mareoEnviosUrl = mareoEnviosUrl;
	}

	public void sendCommand(Shipping shipping, String transition) {
		String url = mareoEnviosUrl + "/shippings/" + shipping.getId() + "/transition";
